...
LooseAggressive 对于较大范围的手牌进行raise
'''
import rlcard
...
class NoLimitholdemLooseAggressiveAgent(object):
...
class NoLimitholdemLooseAggressiveModel(Model):
    ...
    def __init__(self):
        ...
        rule_agent = NoLimitholdemLooseAggressiveAgent()
